...
minikube start --kubernetes-version=${KUBERNETES_VERSION} --cpus=4 --memory=8g --driver=docker --cni=auto --embed-certs=false --feature-gates="EphemeralContainers=true" --addons="dashboard" --addons="metrics-server" --wait=all
