...
minikube start --kubernetes-version=${KUBERNETES_VERSION} --driver=docker --cpus=2 --memory=2g --embed-certs=false --feature-gates="EphemeralContainers=true" --addons="dashboard"
